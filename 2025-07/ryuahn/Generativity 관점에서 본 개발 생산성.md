...
얼마 전 참석한 교육에서 강사님이 Jessitron(Jessica Kerr)의 **"Generativity"** 개념을 소개해주셨습니다. <br>
...
Generativity 실천을 위해서는 '지속 가능한 속도'를 유지하는 것이 중요합니다. 무리한 속도로 단기 목표만 달성하는 것이 아니라, 장기적으로 건강한 개발 환경을 유지하는 속도를 설정해야 합니다.
